...
class SimpleWorkDurationCalculatorTest {

    private SimpleWorkDurationCalculator sut;

    @BeforeEach
    void setUp() {
        sut = new SimpleWorkDurationCalculator();
    }
    ...
    class CalculateWorkDuration {
        ...
        @CsvSource({
            /*
             *  --------------------------------------------------
             * |            [work]  08:00 - 17:00                 |     9h WorkDuration
             *  --------------------------------------------------      1h BreakDuration
             *            | [break] 12:00 - 13:00 |
             *             -----------------------
             */
        ...
        void ensureOverlappingWorkEntryAndBreakEntry(String workFrom, String workTo, String breakFrom, String breakTo) {
            ...
            assertThat(actual.durationInMinutes()).isEqualTo(Duration.ofHours(9));
        }
        ...
        void workDurationForTimeEntriesWithOverlappingBreak() {
            /*
             *  ----------------------        ----------------------
             * | [work] 08:00 - 12:15 |      | [work] 12:45 - 17:00 |       8h 30min WorkDuration
            ...
            assertThat(actual.durationInMinutes()).isEqualTo(Duration.ofHours(8).plusMinutes(30));
        }
