...
class TimeEntryServiceIT extends SingleTenantTestContainersBase {
    ...
    void ensureGetTimeEntriesConsideringTimeZones() {
        ...
        final ZonedDateTime start1 = ZonedDateTime.parse("2025-06-04T23:00:00+00:00[UTC]"); // 2025-06-04 23:00
        ...
        final ZonedDateTime start2 = ZonedDateTime.parse("2025-06-05T23:00:00+00:00[UTC]"); // 2025-06-05 23:00
        ...
        final ZonedDateTime startUtc = ZonedDateTime.parse("2025-06-06T21:10:00+00:00[UTC]"); // 2025-06-06 23:12
        ...
        final ZonedDateTime startInvalid = ZonedDateTime.parse("2025-06-06T23:00:00+00:00[UTC]"); // 2025-06-06 23:00
