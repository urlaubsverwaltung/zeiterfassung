...
class TimeEntryTest {
    ...
    void ensureWorkDurationIsZeroIfBreak() {
        ...
        final TimeEntry timeEntry = new TimeEntry(new TimeEntryId(1L), anyUserIdComposite(), "hard work", from, to, true, null, null);
    ...
    void ensureWorkDurationIsCorrectItNotABreak() {
        ...
        final ZonedDateTime from = dateTime(2021, 1, 4, 1, 0);
        final ZonedDateTime to = dateTime(2021, 1, 4, 2, 0);
        final TimeEntry timeEntry = new TimeEntry(new TimeEntryId(1L), anyUserIdComposite(), "hard work", from, to, false, null, null);
