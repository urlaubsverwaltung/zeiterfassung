...
class ReportCsvServiceTest {
    ...
    void ensureWeekReportCsvRoundsWorkedHoursToTwoDigit() {
        ...
        final ReportDay reportDay = new ReportDay(LocalDate.of(2021, 1, 4), Map.of(batman, PlannedWorkingHours.EIGHT), Map.of(), Map.of(batman.localId(), List.of(reportDayEntry)));
    ...
    void ensureWeekReportCsvContainsSummarizedInfoPerDay() {
        ...
        final ReportDay reportDayOne = new ReportDay(LocalDate.of(2021, 1, 4), Map.of(batman, PlannedWorkingHours.EIGHT), Map.of(), Map.of(batman.localId(), List.of(d1_1_ReportDayEntry, d1_2_ReportDayEntry)));
        ...
        final ReportDay reportDayTwo = new ReportDay(LocalDate.of(2021, 1, 5), Map.of(batman, PlannedWorkingHours.EIGHT), Map.of(), Map.of(batman.localId(), List.of(d2_1_ReportDayEntry)));
    ...
    void ensureMonthReportCsvContainsSummarizedInfoPerDay() {
        ...
        final ZonedDateTime d1_2_To = ZonedDateTime.of(LocalDateTime.of(2021, 1, 4, 15, 0), ZONE_ID_BERLIN);
        final ReportDayEntry d1_2_ReportDayEntry = new ReportDayEntry(batman, "hard work", d1_2_From, d1_2_To, false);
        final ReportDay w1_reportDay = new ReportDay(LocalDate.of(2021, 1, 4), Map.of(batman, PlannedWorkingHours.EIGHT), Map.of(), Map.of(batman.localId(), List.of(d1_1_ReportDayEntry, d1_2_ReportDayEntry)));

        // week two, day one
        final ZonedDateTime d2_1_From = ZonedDateTime.of(LocalDateTime.of(2021, 1, 5, 9, 0), ZONE_ID_BERLIN);
        final ZonedDateTime d2_1_To = ZonedDateTime.of(LocalDateTime.of(2021, 1, 5, 17, 0), ZONE_ID_BERLIN);
        final ReportDayEntry d2_1_ReportDayEntry = new ReportDayEntry(batman, "hard work", d2_1_From, d2_1_To, false);
        final ReportDay w2_reportDay = new ReportDay(LocalDate.of(2021, 1, 5), Map.of(batman, PlannedWorkingHours.EIGHT), Map.of(), Map.of(batman.localId(), List.of(d2_1_ReportDayEntry)));
