...
class ReportWeekControllerTest implements ControllerTest {
    ...
    void setUp() {
        ...
        sut = new ReportWeekController(reportService, reportPermissionService, reportViewHelper, timeEntryDialogHelper,
            userSearchUiFragmentSupplier, clock);
    }
    ...
    class EditTimeEntry {
        ...
        void setUp() {
            ...
            sut = new ReportWeekController(reportService, reportPermissionService, reportViewHelper,
