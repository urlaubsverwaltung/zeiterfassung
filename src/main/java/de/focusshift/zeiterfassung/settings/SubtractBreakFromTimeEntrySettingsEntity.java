...
public class SubtractBreakFromTimeEntrySettingsEntity extends AbstractTenantAwareEntity {
    ...
    private Instant featureLaunchTimestamp;
    ...
    public Instant getFeatureLaunchTimestamp() {
        return featureLaunchTimestamp;
    }

    public void setFeatureLaunchTimestamp(Instant featureLaunchTimestamp) {
        this.featureLaunchTimestamp = featureLaunchTimestamp;
    }
    ...
    public String toString() {
        return "SubtractBreakFromTimeEntrySettingsEntity{" +
            ...
            ", featureLaunchTimestamp=" + featureLaunchTimestamp +
            '}';
    }
}
