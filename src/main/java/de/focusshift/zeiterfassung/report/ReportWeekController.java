...
class ReportWeekController implements HasTimeClock, HasLaunchpad {
    ...
    ReportWeekController(ReportService reportService, ReportPermissionService reportPermissionService, ReportViewHelper reportViewHelper, Clock clock, TimeEntryService timeEntryService, UserManagementService userManagementService) {
