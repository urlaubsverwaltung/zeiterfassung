...
public interface TimeEntryService {
     ...
     * @param from         first date of interval
     * @param toExclusive  last date (exclusive) of interval
     * @param userLocalIds to get {@linkplain TimeEntry}s for
     * @return sorted list of {@linkplain TimeEntry}s grouped by user
     */
    Map<UserIdComposite, List<TimeEntry>> getEntries(LocalDate from, LocalDate toExclusive, Collection<UserLocalId> userLocalIds);
     ...
     */
    TimeEntry createTimeEntry(UserLocalId userLocalId, @Nullable String comment, ZonedDateTime start, ZonedDateTime end, boolean isBreak, @Nullable Long projectId, @Nullable Long activityTypeId);
     ...
     */
    TimeEntry updateTimeEntry(TimeEntryId id, @Nullable String comment, @Nullable ZonedDateTime start, @Nullable ZonedDateTime end, @Nullable Duration duration, boolean isBreak, @Nullable Long projectId, @Nullable Long activityTypeId) throws TimeEntryUpdateNotPlausibleException;
