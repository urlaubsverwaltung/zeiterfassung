...
public class TimeEntryEditModalHelper {
    ...
    public void saveTimeEntry(TimeEntryDTO timeEntryDTO, BindingResult errors, RedirectAttributes redirectAttributes, OidcUser oidcUser) {
        timeEntryViewHelper.saveTimeEntry(timeEntryDTO, errors, redirectAttributes, oidcUser);
    }
