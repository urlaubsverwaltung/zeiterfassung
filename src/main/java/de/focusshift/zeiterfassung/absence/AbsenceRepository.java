...
interface AbsenceRepository extends CrudRepository<AbsenceWriteEntity, Long> {
    ...
    Optional<AbsenceWriteEntity> findByTenantIdAndSourceIdAndType_Category(String tenantId, Long sourceId, String absenceTypeCategory);
    ...
    @Modifying
    @Transactional
    int deleteByTenantIdAndSourceIdAndType_Category(String tenantId, Long sourceId, String absenceTypeCategory);
}
